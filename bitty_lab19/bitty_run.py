...
VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe --trace ./test/{1}/{1}_dpi.cpp bitty_dpi.cpp ./emulator/bitty_emu.cpp ./generator/bitty_instruction_generator.cpp"#verilate dpi
