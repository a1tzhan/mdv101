...
#VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe ./test/{1}/{1}_tb.cpp"                              #verilate tb
#VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe ./test/{1}/{1}_cosim.cpp ./emulator/bitty_emu.cpp"  #verilate cosim
VERILATE_COMMAND = "verilator --assert -I./rtl --Wall {0} --cc ./rtl/{1}.v --exe ./test/{1}/{1}_dpi.cpp bitty_dpi.cpp ./emulator/bitty_emu.cpp ./generator/bitty_instruction_generator.cpp"#verilate dpi
