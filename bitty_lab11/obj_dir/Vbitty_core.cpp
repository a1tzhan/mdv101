...
VL_INLINE_OPT void Vbitty_core::_sequent__TOP__1(Vbitty_core__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->reset) {
        ...
        if (((IData)(vlTOPp->bitty_core__DOT__cu01__DOT__reg_en_c) 
             & (~ (IData)(vlTOPp->reset)))) {
            vlTOPp->bitty_core__DOT__reg_c__DOT__reg_d_out 
                = ((IData)(vlTOPp->bitty_core__DOT__cu01__DOT__reg_alu_mode)
                    ? (IData)(vlTOPp->bitty_core__DOT__alu01__DOT__alu1__DOT__lu01__DOT__lo_out_temp)
                    : (IData)(vlTOPp->bitty_core__DOT__alu01__DOT__alu1__DOT__au01__DOT__ar_out_temp));
        }
    }
}
