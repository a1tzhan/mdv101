...
void Vbitty_core::_ctor_var_reset() {
    ...
    bitty_core__DOT__cu01__DOT__reg_imm = VL_RAND_RESET_I(16);
    bitty_core__DOT__cu01__DOT__current_state = VL_RAND_RESET_I(2);
    bitty_core__DOT__cu01__DOT__next_state = VL_RAND_RESET_I(2);
    bitty_core__DOT__cu01__DOT__reg_alu_sel = VL_RAND_RESET_I(3);
    bitty_core__DOT__cu01__DOT__reg_mux_sel = VL_RAND_RESET_I(4);
